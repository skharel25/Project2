...
<head>
	...
	<style>
		html, body, table {margin: 0; padding: 0; background-color: blue; color: black;}
		td, th {text-align: center; vertical-align: middle; border: 1px black solid;}
		table {width: 100vw; height: 100vh; border-spacing: 10; border-collapse: collapse;}

		.game td {width: 20vw; height: 16.66vh; font-size: 50px;}
		.game th {width: 20vw; height: 16.66vh; font-size: 50px;}
		.game td.tile {cursor: grab;}
		.game td.tile:hover {background-color: white ;}
		...
		.question .award {width: 15vw; height: 15vh; font-size: 5vh; background-color: #006600; cursor: grab; -webkit-user-select: none;}
		.question .award:hover {background-color: red;}
		.question .award.wrong {background-color: red;}
